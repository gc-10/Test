        ...
        <!--<div id="contenitorePrincipale">
            <div id="contenitoreTesto">
                <p>
                    ...
                    <br><br>Tutto ciò rappresenta delle vere e proprie eccellenze del territorio.
                </p>
            </div>
            <img src="../img/immagine_tenuta.png" id="immaginePrincipale"> 
        </div>-->
        <footer>
            2025 © AZIENDA AGRICOLA PARADISO SOCIETÁ SEMPLICE AGRICOLA - Partita IVA: 07068870489 <br>
            <a href="../pages/cookie-policy.html">Cookie Policy</a>&nbsp;&nbsp;&nbsp;<a href="../pages/privacy-policy.html">Privacy Policy</a>
        </footer>
    </div>
    <!-- Si sale di una base -->
    <script>
